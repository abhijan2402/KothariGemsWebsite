      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        >
          ...
          <p className="text-gray-300 text-md leading-relaxed">
            ...
            this industry but also budding individuals with the same dedication.
          </p>
        ...
        >
          ...
          <p className="text-gray-300 text-md leading-relaxed">
            ...
            enables us to uphold the strictest standards for proportion, polish,
            size, and shape.
          </p>
          <p className="text-gray-300 mt-3">
            Our constant urge for innovation allows us to play a pioneering role
            in many developments in the industry.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 text-md leading-relaxed">
            ...
            relationships with ethically mined gemstone suppliers worldwide. Our
            main sources are the USA, Germany, Thailand, Hong Kong, Brazil &
            Tanzania.
          </p>
          <p className="text-gray-300 mt-3">
            We follow industry-standard protocols and ensure our suppliers
            employ skilled human resources with certifications. We at Kothari
        ...
        >
          ...
          <p className="text-gray-300 text-md leading-relaxed">
            Our manufacturing unit is equipped with the latest technology tools,
            including fully automatic 3D CNC machines for precision cutting and
            carving. Our goal is to integrate modern technology with the
            gemstone industry, ensuring bulk production with consistent quality
            and reduced dependency on manual labor.
          </p>
        </motion.div>
      </div>
    </section>
